    ...
    <section className="section">
      <div className="container">
        <Reveal className="cta-band">
          <span className="blob b2" aria-hidden="true" style={{ background: 'var(--secondary)', width: 260, height: 260, top: -90, right: -60 }} />
          <span className="blob" aria-hidden="true" style={{ background: 'var(--blue-500)', width: 220, height: 220, bottom: -90, left: -40, opacity: 0.5 }} />
