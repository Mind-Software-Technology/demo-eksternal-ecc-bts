...
export const api = {
  ...
  admin: {
    ...
    testimonials: {
      list: () => request('/api/admin/testimonials').then(unwrapList),
      toggleActive: (id) => request(`/api/admin/testimonials/${id}/toggle-active`, { method: 'PATCH' }),
    },
    faqs: adminCrud('faqs'),
    ...
    orders: {
      ...
      submitQuote: (orderNo, items) =>
        request(`/api/admin/orders/${orderNo}/quote`, { method: 'POST', body: { items } }),
    },
    payments: {
